# Contributing to todover

✨ Thanks for contributing to **todover**! ✨
...
Help us keep **todover** open and inclusive. Please read and follow our [Code of conduct](CODE_OF_CONDUCT.md).

## How can I contribute?

### Improve documentation/language

As a **todover** user, you are the perfect candidate to help us improve our documentation or the product: typo corrections, clarifications, etc..
In addition, you can feel free to make suggestions about different language improvements in this [directory](https://github.com/FlorianWoelki/todover/tree/main/packages/i18n/locales).
...
Please try to be as detailed as possible in your report and fill the information requested.

### Feature request

Feature requests are welcome, but take a moment to find out whether your idea fits with the scope and aims of the project.
It's up to you to make a strong case to convince the project's developers of the merits of this feature.
Please provide as much detail and context as possible and fill the information requested.
...
| **chore**      | Styling changes or improvements                                                                             |
| **feat**       | A new feature                                                                                               |
| **fix**        | A bug fix                                                                                                   |
...
```commit
`fix(store): remove duplicates in vuex`
```

```commit
`feat(comp): add 'Todo' component`
...
$ git remote add upstream https://github.com/FlorianWoelki/todover.git
